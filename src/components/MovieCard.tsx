          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/70 to-transparent opacity-100 md:opacity-0 flex flex-col justify-end p-2.5 md:hidden pointer-events-none">
            <div className="pointer-events-auto flex flex-col w-full relative z-30">
              ...
              <div className="flex flex-col space-y-1.5">
                ...
                >
                  {isLoadingTrailer ? '...' : <><Play className="w-3 h-3 fill-current" /> Trailer</>}
                </button>
                <button 
        ...
        <AnimatePresence>
          {isHovered && (
            <motion.div
              ...
              className="absolute top-1/2 left-1/2 w-full bg-[#141414] rounded-lg overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.9)] border border-neutral-700 z-50 flex flex-col cursor-pointer"
            >
