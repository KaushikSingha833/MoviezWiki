    ...
    <>
      <div className="flex space-x-4 pt-4">
        <button 
          ...
          disabled={isLoading}
          className="bg-[#F5C518] text-black font-bold py-3 px-8 rounded-md hover:bg-yellow-500 hover:scale-105 transition-all duration-300 flex items-center shadow-lg disabled:opacity-50"
        >
        ...
        <button 
          ...
          className="bg-neutral-500/50 text-white font-bold py-3 px-8 rounded-md hover:bg-neutral-500/70 hover:scale-105 transition-all duration-300 flex items-center backdrop-blur-sm shadow-lg border border-neutral-500/50"
        >
